<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="ToegangsControleSysteem.Index1" %>
    ...
    <h1 id="title" runat="server"></h1>
        ...
        <asp:GridView ID="eventGridView" runat="server" CellPadding="3" ForeColor="Black" GridLines="Vertical" AutoGenerateColumns="False" Width="960px" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px">
            ...
            <Columns>
                ...
                <asp:HyperLinkField HeaderText="Event Name" DataTextField="EventName" DataNavigateUrlFields="RowNumber" DataNavigateUrlFormatString="EventReservations.aspx?EventID={0}" />
