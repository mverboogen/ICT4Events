<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="CheckInItem.aspx.cs" Inherits="MateriaalBeheerSysteem.CheckInItem" %>
<asp:Content ID="Content1" ContentPlaceHolderID="contentPH" runat="server">
    <div id="titleContainer" runat="server">
        <h1 id="title" runat="server">In Checken</h1>
    </div>
    <div id="container" runat="server">
        ...
        <div id="detail" runat="server">
            ...
            <div id="detailInput" runat="server">
                ...
                <p><asp:Button ID="checkInBtn" runat="server" Text="In Checken" OnClick="checkInBtn_Click" /></p>
                <p></p>
